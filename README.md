...
Quick angular code challenge by Jonathan Lazo

##set up

#Dependecies
This applicactions uses npm and gulp to manage dependencies and run task  please after run `npm install`, make sure you have angular, bower, karma and gulp installed.
